...
export default function UpdateReservation() {
    ...
    const onSubmit=async (e)=> {
        e.preventDefault();
        await axios.put(`http://16.171.135.69:8888/reservation/update/${reservationId}`, user);
        navigate("/reservation/viewall")
    };

    const loadUser=async()=>{
        const result = await axios.get(`http://16.171.135.69:8888/reservation/view/${reservationId}`);
        setUser(result.data);
    }
